...
; TreeMons indexes (see data/wild/treemons.asm)
	...
	const TREEMON_SET_SILVER
	const TREEMON_SET_EAST
...
DEF BASE_HAPPINESS        EQU 64
DEF FRIEND_BALL_HAPPINESS EQU 128
DEF HAPPINESS_TO_EVOLVE   EQU 192
DEF HAPPINESS_THRESHOLD_1 EQU 96
DEF HAPPINESS_THRESHOLD_2 EQU 192
