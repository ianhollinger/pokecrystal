...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM51_RAZOR_WIND
...
; Kanto hidden items
	...
	const EVENT_GOT_TM66_HYDRO_PUMP
...
; Rematches
	const EVENT_BEAT_FALKNER2
	const EVENT_BEAT_BUGSY2
	const EVENT_BEAT_WHITNEY2
	const EVENT_BEAT_MORTY2
	const EVENT_BEAT_JASMINE2
	const EVENT_BEAT_CHUCK2
	const EVENT_BEAT_PRYCE2
	const EVENT_BEAT_CLAIR2
; Kanto Gym Leaders
...
; Kanto people
	...
	const EVENT_TELEPORT_GUY
        const EVENT_ICE_PATH_1F_ARTICUNO
        const EVENT_ROCK_TUNNEL_1F_ZAPDOS
        const EVENT_SILVER_CAVE_ITEM_ROOMS_MOLTRES
        const EVENT_MOUNT_MORTAR_B1F_MEWTWO
...
; New to Crystal
	...
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_HIDDEN_LINKING_CORD
	const EVENT_CIANWOOD_GYM_GUIDE
	const EVENT_CELADON_GYM_GUIDE
	const EVENT_CELADON_GAME_CORNER_GYM_GUIDE
	const EVENT_CIANWOOD_POKECENTER_GYM_GUIDE
