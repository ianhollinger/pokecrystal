...
; Kanto hidden items
	...
	const EVENT_DIDNT_CATCH_MEWTWO
	const EVENT_DIDNT_CATCH_ARTICUNO
	const EVENT_DIDNT_CATCH_ZAPDOS
	const EVENT_DIDNT_CATCH_MOLTRES
	const EVENT_DIDNT_CATCH_SUDOWOODO
	const EVENT_DIDNT_CATCH_SNORLAX
