...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ZAP_CANNON, HIDDEN_POWER, SUNNY_DAY, ICY_WIND, PROTECT, RAIN_DANCE, GIGA_DRAIN, ENDURE, FRUSTRATION, THUNDER, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, THUNDERBOLT, SUBSTITUTE, MIMIC, SELFDESTRUCT, NIGHT_SHADE, EXPLOSION, MEGA_DRAIN, DOUBLE_EDGE, METRONOME, PAIN_SPLIT
	; end
