...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, THUNDERPUNCH, REST, ATTRACT, FIRE_PUNCH, STRENGTH, FLAMETHROWER, ANCIENTPOWER, ROCK_SLIDE, EXPLOSION, BODY_SLAM, SUBMISSION, SELFDESTRUCT, METRONOME, SEISMIC_TOSS, SUBSTITUTE, MIMIC, DOUBLE_EDGE
	; end
