...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm ROAR, DYNAMICPUNCH, HEADBUTT, CURSE, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, THUNDERPUNCH, REST, ATTRACT, FIRE_PUNCH, STRENGTH, FLASH, THUNDERBOLT, DOUBLE_EDGE, SUBSTITUTE, MIMIC, SEISMIC_TOSS, OUTRAGE, THUNDER_WAVE, SAFEGUARD, LIGHT_SCREEN, REFLECT, BODY_SLAM, HEAL_BELL, SUNNY_DAY, ICE_PUNCH, DIG
	; end
