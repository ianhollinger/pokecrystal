...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, REST, ATTRACT, THIEF, STRENGTH, SUBSTITUTE, MIMIC, DOUBLE_EDGE, BODY_SLAM, SEISMIC_TOSS, ROCK_SLIDE, BATON_PASS, REVERSAL, SWORDS_DANCE, SUBMISSION, METRONOME
	; end
