...
;	dw NULL, NULL ; unused (beta front/back pics)
	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROAR, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, THUNDER, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, SWIFT, REST, STEEL_WING, FLY, FLASH, THUNDERBOLT, SUBSTITUTE, MIMIC, DOUBLE_EDGE, SKY_ATTACK, ANCIENTPOWER, RAZOR_WIND, THUNDER_WAVE, BATON_PASS, LIGHT_SCREEN, REFLECT
	; end
