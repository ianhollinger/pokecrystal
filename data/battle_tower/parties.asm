...
; BattleTowerMons group 1
	...
	db ESPEON
	db LEFTOVERS
	db MUD_SLAP, PSYCHIC_M, SHADOW_BALL, HIDDEN_POWER ; HP WATER
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_TAIL, TOXIC, CHARM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db MILTANK
	db GOLD_BERRY
	db BLIZZARD, EARTHQUAKE, DOUBLE_EDGE, SWAGGER
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db AERODACTYL
	db LEFTOVERS
	db FIRE_BLAST, SUPERSONIC, EARTHQUAKE, BITE
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db GOLD_BERRY
	db HYPNOSIS, GIGA_DRAIN, THIEF, PSYCHIC_M
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db HERACROSS
	db FOCUS_BAND
	db REVERSAL, ENDURE, EARTHQUAKE, MEGAHORN
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, TAIL_WHIP, PROTECT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
