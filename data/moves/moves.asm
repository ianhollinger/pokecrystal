...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLE_EDGE,  EFFECT_DOUBLE_EDGE,       120, NORMAL,        PHYSICAL, 100, 15,   0
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,      PHYSICAL,  80, 20,   0
	move LOW_KICK,     EFFECT_LOW_KICK,            1, FIGHTING,      PHYSICAL, 100, 20,   0
	...
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL,        PHYSICAL,  90, 15,   0
