...
Route20_MapScripts:
	...
	callback MAPCALLBACK_NEWMAP, Route20ClearRocksCallback
        callback MAPCALLBACK_OBJECTS, Route20ArticunoCallback
...
Route20_MapEvents:
	...
	object_event 12, 13, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerSwimmermCameron, -1
        object_event 31,  5, SPRITE_MOLTRES, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route20ArticunoScript, EVENT_ROUTE_20_ARTICUNO
