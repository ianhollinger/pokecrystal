...
CeladonGameCorner_MapEvents:
	...
	object_event 11,  3, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeladonGymGuideScript, EVENT_CELADON_GAME_CORNER_GYM_GUIDE
