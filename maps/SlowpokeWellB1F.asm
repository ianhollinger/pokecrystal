...
SlowpokeWellB1F_MapScripts:
	def_scene_scripts
	scene_script SlowpokeWellB1FNoop1Scene, SCENE_PROTON

	def_callbacks

SlowpokeWellB1FNoop1Scene:
	end
...
SlowpokeWellB1F_MapEvents:
	...
	def_coord_events
	coord_event 5, 3, SCENE_PROTON, TrainerGruntM1
	...
	object_event  5,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, TrainerGruntM1, EVENT_SLOWPOKE_WELL_ROCKETS
