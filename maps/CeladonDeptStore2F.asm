	...
	const CELADONDEPTSTORE2F_CLERK3
...
CeladonDeptStore2FClerk3Script:
	faceplayer
	opentext
	pokemart MARTTYPE_STANDARD, MART_CELADON_2F_3
	closetext
	end
...
CeladonDeptStore2F_MapEvents:
	...
	object_event 13,  6, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeladonDeptStore2FClerk3Script, -1
