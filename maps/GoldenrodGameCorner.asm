DEF GOLDENRODGAMECORNER_TM16_COINS       EQU 2500
DEF GOLDENRODGAMECORNER_TM58_COINS       EQU 4000
DEF GOLDENRODGAMECORNER_TM71_COINS       EQU 6000
...
DEF GOLDENRODGAMECORNER_DRATINI_COINS    EQU 4000
DEF GOLDENRODGAMECORNER_PORYGON_COINS    EQU 8000
...
.IcyWind:
	...
	takecoins GOLDENRODGAMECORNER_TM16_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript

.Crunch:
	checkitem TM_CRUNCH
	iftrue GoldenrodGameCornerPrizeVendor_AlreadyHaveTMScript
	checkcoins GOLDENRODGAMECORNER_TM58_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	...
	giveitem TM_CRUNCH
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM58_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript

.PetalDance:
	checkitem TM_PETAL_DANCE
	iftrue GoldenrodGameCornerPrizeVendor_AlreadyHaveTMScript
	checkcoins GOLDENRODGAMECORNER_TM71_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	getitemname STRING_BUFFER_3, TM_PETAL_DANCE
	scall GoldenrodGameCornerPrizeVendor_ConfirmPurchaseScript
	iffalse GoldenrodGameCornerPrizeVendor_CancelPurchaseScript
	giveitem TM_PETAL_DANCE
	iffalse GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	takecoins GOLDENRODGAMECORNER_TM71_COINS
	sjump GoldenrodGameCornerTMVendor_FinishScript
...
.loop
	...
	ifequal 1, .Horsea
	ifequal 2, .Wobbuffet
	ifequal 3, .Kangaskhan
	ifequal 4, .Dratini
	ifequal 5, .Porygon
	sjump GoldenrodGameCornerPrizeVendor_CancelPurchaseScript

.Horsea:
	checkcoins GOLDENRODGAMECORNER_HORSEA_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	getmonname STRING_BUFFER_3, HORSEA
	scall GoldenrodGameCornerPrizeVendor_ConfirmPurchaseScript
	iffalse GoldenrodGameCornerPrizeVendor_CancelPurchaseScript
	waitsfx
	playsound SFX_TRANSACTION
	...
	givepoke HORSEA, 15
	takecoins GOLDENRODGAMECORNER_HORSEA_COINS
	sjump .loop
...
.Kangaskhan:
	checkcoins GOLDENRODGAMECORNER_KANGASKHAN_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	...
	takecoins GOLDENRODGAMECORNER_KANGASKHAN_COINS
	sjump .loop
