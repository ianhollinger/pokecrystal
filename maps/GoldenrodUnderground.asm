...
DEF GOLDENRODUNDERGROUND_YOUNGER_HAIRCUT_PRICE EQU 300
	...
	const GOLDENRODUNDERGROUND_TYPE_ITEM
...
; Sunday
	...
	disappear GOLDENRODUNDERGROUND_TYPE_ITEM
...
.NotMondayMorning:
	...
	appear GOLDENRODUNDERGROUND_TYPE_ITEM
	endcallback
...
.Monday:
	pokemart MARTTYPE_TYPE_ITEM, MART_UNDERGROUND2
	closetext
	end
...
GoldenrodUnderground_MapEvents:
	...
	object_event  7, 20, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, TypeItemMerchantScript, EVENT_GOLDENROD_UNDERGROUND_TYPE_ITEM
