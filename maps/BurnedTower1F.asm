...
BurnedTowerRivalBattleScript:
	...
	loadtrainer RIVAL2, RIVAL1_3_TOTODILE
	startbattle
	dontrestartmapmusic
...
.totodile
	winlosstext BurnedTowerRival_WinText, BurnedTowerRival_LossText
	setlasttalked BURNEDTOWER1F_RIVAL
	loadtrainer RIVAL2, RIVAL1_3_CHIKORITA
	startbattle
	dontrestartmapmusic
	reloadmapafterbattle
	sjump .returnfrombattle
...
.chikorita
	winlosstext BurnedTowerRival_WinText, BurnedTowerRival_LossText
	setlasttalked BURNEDTOWER1F_RIVAL
	loadtrainer RIVAL2, RIVAL1_3_CYNDAQUIL
	startbattle
	dontrestartmapmusic
	reloadmapafterbattle
	sjump .returnfrombattle
...
BurnedTower1FHiddenUltraBall:
	hiddenitem  BRICK_PIECE, EVENT_BURNED_TOWER_1F_HIDDEN_ULTRA_BALL
