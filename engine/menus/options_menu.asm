...
.master:
	...
	lb de, DIFFICULTY_HARD, DIFFICULTY_ROOKIE
	ret


.hard
	ld c, OPT_DIFFICULTY_HARD
	lb de, DIFFICULTY_NORMAL, DIFFICULTY_MASTER
	ret

.easy
	ld c, OPT_DIFFICULTY_EASY
	lb de, DIFFICULTY_ROOKIE, DIFFICULTY_NORMAL
	ret

.rookie:
	ld c, OPT_DIFFICULTY_ROOKIE
	lb de, DIFFICULTY_MASTER, DIFFICULTY_EASY
	ret
